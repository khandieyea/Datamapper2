 ...
 *
 * Iterator for DataMapper get_iterated results
 *
 * @license 	MIT License
...
class DataMapper_DatasetIterator implements Iterator, Countable
{
	/**
	...
	function get($index)
	{
		...
		$this->parent->dm_to_object($this->object, $this->result[$index]);
		return $this->object;
	}
...
/* Location: ./application/third_party/datamapper/datamapper/datasetiterator.php */
